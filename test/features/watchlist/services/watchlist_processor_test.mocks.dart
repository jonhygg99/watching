...
// in watching/test/features/watchlist/services/watchlist_processor_test.dart.
...
/// A class which mocks [WatchlistEpisodeService].
///
/// See the documentation for Mockito's code generation for more information.
class MockWatchlistEpisodeService extends _i1.Mock
    implements _i4.WatchlistEpisodeService {
  MockWatchlistEpisodeService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<Map<String, dynamic>?> getNextEpisode(
    dynamic trakt,
    String? traktId,
    Map<String, dynamic>? progress,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getNextEpisode, [trakt, traktId, progress]),
            returnValue: _i5.Future<Map<String, dynamic>?>.value(),
          )
          as _i5.Future<Map<String, dynamic>?>);
}

/// A class which mocks [TraktClient].
///
/// See the documentation for Mockito's code generation for more information.
class MockTraktClient extends _i1.Mock implements _i6.TraktClient {
  MockTraktClient() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<Map<String, dynamic>> getShowWatchedProgress({
    required String? id,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getShowWatchedProgress, [], {#id: id}),
            returnValue: _i5.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i5.Future<List<Map<String, dynamic>>> getShowTranslations({
    required String? id,
    required String? language,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#getShowTranslations, [], {
              #id: id,
              #language: language,
            }),
  ...
  @override
  _i5.Future<Map<String, dynamic>> getEpisodeInfo({
    required String? id,
    required int? season,
    ...
    String? language,
      ...
      (super.noSuchMethod(
            Invocation.method(#getEpisodeInfo, [], {
              #id: id,
              #season: season,
              #episode: episode,
              #language: language,
