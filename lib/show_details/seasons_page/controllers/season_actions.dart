...
class _BatchEpisodeAction {
  ...
  Timer? _batchTimer;
  final Map<int, Set<int>> _episodesToAdd =
      {}; // season -> episode numbers to add
  final Map<int, Set<int>> _episodesToRemove =
      {}; // season -> episode numbers to remove
...
class SeasonActions {
  ...
  static Future<void> handleToggleEpisode({
    ...
    final previousEpisodesState = List<Map<String, dynamic>>.from(
      episodesState.value,
    );
    final previousProgressState =
