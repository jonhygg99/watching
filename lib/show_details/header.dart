...
class ShowDetailHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fanartUrl =
        images['fanart'] != null && images['fanart'].isNotEmpty
            ? 'https://${images['fanart'][0]}'
            : null;
    final posterUrl =
        images['poster'] != null && images['poster'].isNotEmpty
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Switch(value: showOriginal, onChanged: onToggleOriginal),
          ],
        ),
        ...
        Wrap(
          ...
          children: [
            ...
            if ((show['genres'] as List?)?.isNotEmpty == true)
              Chip(
                label: Text('Géneros: ${(show['genres'] as List).join(', ')}'),
              ),
            if ((certifications)?.isNotEmpty == true)
              ...certifications!
                  ...
                  .map(
                    (c) =>
                        Chip(label: Text('Certificado: ${c['certification']}')),
                  ),
          ],
        ),
