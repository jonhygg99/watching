              ...
              children: [
                ...
                Container(
                  height: textTheme.titleMedium?.fontSize != null 
                      ? textTheme.titleMedium!.fontSize! * 1.4 // Account for line height
                      : 24,
                  width: 200,
                  color: Colors.grey[300],
                ...
                Container(
                  height: textTheme.bodyMedium?.fontSize != null 
                      ? textTheme.bodyMedium!.fontSize! * 1.4 // Account for line height
                      : 20,
                  width: 180,
                  color: Colors.grey[300],
                  margin: const EdgeInsets.only(bottom: 6), // Matches the SizedBox(height: 6) in _ProgressDetails
                ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        height: textTheme.bodySmall?.fontSize != null 
                            ? textTheme.bodySmall!.fontSize! * 1.4 // Account for line height
                            : 16,
                        color: Colors.grey[300],
                      ),
                    ],
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.grey[300],
                    borderRadius: BorderRadius.circular(18), // Standard button border radius
                  ),
                ),
              ],
            ),
